...
serve(async (req) => {
  ...
  try {
    ...
    // Comprehensive ISO 3166-1 alpha-2 → known multilingual variants map.
    // Includes English name, common abbreviations, native names, French/German/Spanish/Italian/Russian/Romanian/Polish/etc. variants.
    const COUNTRY_VARIANTS: Record<string, string[]> = {
      AF: ["AF", "Afghanistan", "Afganistan"],
      AL: ["AL", "Albania", "Shqipëria", "Albanie", "Albanien"],
      DZ: ["DZ", "Algeria", "Algérie", "Argelia", "Algeria", "Algeriet"],
      AD: ["AD", "Andorra", "Andorre"],
      AO: ["AO", "Angola"],
      AG: ["AG", "Antigua and Barbuda"],
      AR: ["AR", "Argentina", "Argentine", "Argentinien"],
      AM: ["AM", "Armenia", "Armenie", "Հայաստան", "Armenien"],
      AU: ["AU", "Australia", "Australie", "Australien"],
      AT: ["AT", "Austria", "Austria", "Österreich", "Autriche", "Avstrija"],
      AZ: ["AZ", "Azerbaijan", "Azerbaidjan", "Aserbaidschan"],
      BS: ["BS", "Bahamas"],
      BH: ["BH", "Bahrain", "Bahrein"],
      BD: ["BD", "Bangladesh", "Bangladeš"],
      BB: ["BB", "Barbados"],
      BY: ["BY", "Belarus", "Belarus", "Беларусь", "Biélorussie", "Bielorussia", "Bielorusia"],
      BE: ["BE", "Belgium", "Belgique", "België", "Belgien", "Belgio", "Bélgica"],
      BZ: ["BZ", "Belize", "Belice"],
      BJ: ["BJ", "Benin", "Bénin"],
      BT: ["BT", "Bhutan", "Bhoutan"],
      BO: ["BO", "Bolivia", "Bolivie", "Bolivien"],
      BA: ["BA", "Bosnia and Herzegovina", "Bosnia", "Bosnie-Herzégovine", "Bosnien"],
      BW: ["BW", "Botswana"],
      BR: ["BR", "Brazil", "Brasil", "Brésil", "Brasilien", "Brasile", "Brazilia"],
      BN: ["BN", "Brunei"],
      BG: ["BG", "Bulgaria", "Bulgarie", "България", "Bulgarien", "Bulgarien"],
      BF: ["BF", "Burkina Faso"],
      BI: ["BI", "Burundi"],
      KH: ["KH", "Cambodia", "Cambodge", "Kambodscha", "Cambogia", "Camboja"],
      CM: ["CM", "Cameroon", "Cameroun", "Kamerun"],
      CA: ["CA", "Canada", "Kanada"],
      CV: ["CV", "Cape Verde", "Cabo Verde"],
      CF: ["CF", "Central African Republic", "République centrafricaine"],
      TD: ["TD", "Chad", "Tchad"],
      CL: ["CL", "Chile", "Chili", "Chili"],
      CN: ["CN", "China", "Chine", "中国", "Cina", "Chinei"],
      CO: ["CO", "Colombia", "Colombie", "Kolumbien"],
      KM: ["KM", "Comoros", "Comores"],
      CG: ["CG", "Congo"],
      CR: ["CR", "Costa Rica"],
      HR: ["HR", "Croatia", "Hrvatska", "Croatie", "Kroatien", "Croazia", "Croacia", "Croația"],
      CU: ["CU", "Cuba"],
      CY: ["CY", "Cyprus", "Chypre", "Zypern", "Cipro", "Cipru"],
      CZ: ["CZ", "Czech Republic", "Czechia", "Česko", "République tchèque", "Tschechien", "Cehia"],
      DK: ["DK", "Denmark", "Danmark", "Danemark", "Dänemark", "Danimarca", "Dinamarca"],
      DJ: ["DJ", "Djibouti"],
      DM: ["DM", "Dominica"],
      DO: ["DO", "Dominican Republic", "República Dominicana", "République dominicaine"],
      CD: ["CD", "DR Congo", "Congo-Kinshasa"],
      EC: ["EC", "Ecuador", "Équateur", "Ekuador"],
      EG: ["EG", "Egypt", "Égypte", "Ägypten", "Egitto", "Egipto", "Egipt"],
      SV: ["SV", "El Salvador"],
      GQ: ["GQ", "Equatorial Guinea"],
      ER: ["ER", "Eritrea"],
      EE: ["EE", "Estonia", "Eesti", "Estonie", "Estonien", "Estland"],
      SZ: ["SZ", "Eswatini", "Swaziland"],
      ET: ["ET", "Ethiopia", "Éthiopie", "Etiopia"],
      FJ: ["FJ", "Fiji"],
      FI: ["FI", "Finland", "Suomi", "Finlande", "Finnland", "Finlandia", "Finlanda"],
      FR: ["FR", "France", "Franța", "Franta", "Frankreich", "Francia", "Francja", "Франция", "Frankrijk"],
      GA: ["GA", "Gabon"],
      GM: ["GM", "Gambia"],
      GE: ["GE", "Georgia", "Géorgie", "Georgien", "Gruzia"],
      DE: ["DE", "Germany", "Deutschland", "Allemagne", "Germania", "Alemania", "Germania", "Niemcy", "Германия"],
      GH: ["GH", "Ghana"],
      GR: ["GR", "Greece", "Ελλάδα", "Grèce", "Griechenland", "Grecia", "Grecia"],
      GD: ["GD", "Grenada"],
      GT: ["GT", "Guatemala"],
      GN: ["GN", "Guinea", "Guinée"],
      GW: ["GW", "Guinea-Bissau"],
      ...
      HN: ["HN", "Honduras"],
      HK: ["HK", "Hong Kong", "香港"],
      HU: ["HU", "Hungary", "Magyarország", "Hongrie", "Ungarn", "Ungheria", "Hungría", "Ungaria"],
      IS: ["IS", "Iceland", "Ísland", "Islande", "Island", "Islanda", "Islandia"],
      IN: ["IN", "India", "Inde", "Indien", "Indii"],
      ID: ["ID", "Indonesia", "Indonésie", "Indonezia"],
      IR: ["IR", "Iran"],
      IQ: ["IQ", "Iraq", "Irak"],
      IE: ["IE", "Ireland", "Éire", "Irlande", "Irland", "Irlanda", "Irlanda"],
      IL: ["IL", "Israel", "Israël", "Israele"],
      IT: ["IT", "Italy", "Italia", "Italie", "Italien", "Italia"],
      CI: ["CI", "Ivory Coast", "Côte d'Ivoire"],
      JM: ["JM", "Jamaica", "Jamaïque"],
      JP: ["JP", "Japan", "日本", "Japon", "Japón", "Giappone", "Japonia"],
      JO: ["JO", "Jordan", "Jordanie", "Iordania"],
      KZ: ["KZ", "Kazakhstan", "Kazahstan"],
      KE: ["KE", "Kenya"],
      KI: ["KI", "Kiribati"],
      XK: ["XK", "Kosovo"],
      KW: ["KW", "Kuwait", "Koweït"],
      KG: ["KG", "Kyrgyzstan", "Kârgâzstan"],
      LA: ["LA", "Laos"],
      LV: ["LV", "Latvia", "Latvija", "Lettonie", "Lettland", "Letonia"],
      LB: ["LB", "Lebanon", "Liban", "Libano"],
      LS: ["LS", "Lesotho"],
      LR: ["LR", "Liberia"],
      LY: ["LY", "Libya", "Libye", "Libia"],
      LI: ["LI", "Liechtenstein"],
      LT: ["LT", "Lithuania", "Lietuva", "Lituanie", "Litauen", "Lituania"],
      LU: ["LU", "Luxembourg", "Luxemburg", "Lussemburgo", "Luxemburgo"],
      MG: ["MG", "Madagascar"],
      MW: ["MW", "Malawi"],
      MY: ["MY", "Malaysia", "Malaisie", "Malasia", "Malaezia"],
      MV: ["MV", "Maldives"],
      ML: ["ML", "Mali"],
      MT: ["MT", "Malta", "Malte"],
      MH: ["MH", "Marshall Islands"],
      MR: ["MR", "Mauritania", "Mauritanie"],
      MU: ["MU", "Mauritius", "Maurice"],
      MX: ["MX", "Mexico", "México", "Mexique", "Messico", "Mexic"],
      FM: ["FM", "Micronesia"],
      MD: ["MD", "Moldova", "Republica Moldova", "Moldavie", "Moldavien"],
      MC: ["MC", "Monaco", "Mónaco"],
      MN: ["MN", "Mongolia", "Mongolie"],
      ME: ["ME", "Montenegro", "Crna Gora", "Muntenegru"],
      MA: ["MA", "Morocco", "Maroc", "Marokko", "Marocco", "Marruecos", "Maroc"],
      MZ: ["MZ", "Mozambique"],
      MM: ["MM", "Myanmar", "Birmanie"],
      NA: ["NA", "Namibia", "Namibie"],
      NR: ["NR", "Nauru"],
      NP: ["NP", "Nepal", "Népal"],
      NL: ["NL", "Netherlands", "Nederland", "Pays-Bas", "Niederlande", "Paesi Bassi", "Países Bajos", "Olanda", "Țările de Jos"],
      NZ: ["NZ", "New Zealand", "Nouvelle-Zélande", "Neuseeland", "Noua Zeelandă"],
      NI: ["NI", "Nicaragua"],
      NE: ["NE", "Niger"],
      NG: ["NG", "Nigeria", "Nigéria"],
      KP: ["KP", "North Korea", "Corée du Nord", "Coreea de Nord"],
      MK: ["MK", "North Macedonia", "Macedonia", "Macedoine", "Macedonia de Nord"],
      NO: ["NO", "Norway", "Norge", "Norvège", "Norwegen", "Norvegia", "Noruega"],
      OM: ["OM", "Oman", "Sultanate of Oman"],
      PK: ["PK", "Pakistan"],
      PW: ["PW", "Palau"],
      PS: ["PS", "Palestine", "Palestina"],
      PA: ["PA", "Panama", "Panamá"],
      PG: ["PG", "Papua New Guinea"],
      PY: ["PY", "Paraguay"],
      PE: ["PE", "Peru", "Pérou", "Perù"],
      PH: ["PH", "Philippines", "Filipinas", "Filipine"],
      PL: ["PL", "Poland", "Polska", "Pologne", "Polen", "Polonia", "Polonia"],
      PT: ["PT", "Portugal", "Portogallo", "Portugalia"],
      QA: ["QA", "Qatar"],
      RO: ["RO", "Romania", "România", "Roumanie", "Rumänien", "Rumania", "Rumanía", "Romênia", "Ρουμανία", "Румыния"],
      RU: ["RU", "Russia", "Россия", "Russie", "Russland", "Russia", "Rusia", "Rusia"],
      RW: ["RW", "Rwanda"],
      ...
      SA: ["SA", "Saudi Arabia", "Arabie saoudite", "Arabia Saudită"],
      SN: ["SN", "Senegal", "Sénégal"],
      RS: ["RS", "Serbia", "Србија", "Serbie", "Serbien", "Serbia"],
      SC: ["SC", "Seychelles"],
      SL: ["SL", "Sierra Leone"],
      SG: ["SG", "Singapore", "Singapour", "Singapur"],
      SK: ["SK", "Slovakia", "Slovensko", "Slovaquie", "Slowakei", "Slovacchia", "Eslovaquia", "Slovacia"],
      SI: ["SI", "Slovenia", "Slovenija", "Slovénie", "Slowenien", "Eslovenia"],
      SB: ["SB", "Solomon Islands"],
      SO: ["SO", "Somalia", "Somalie"],
      ZA: ["ZA", "South Africa", "Afrique du Sud", "Südafrika", "Sudafrica", "Africa de Sud"],
      KR: ["KR", "South Korea", "한국", "Corée du Sud", "Coreea de Sud"],
      SS: ["SS", "South Sudan", "Sudan de Sud"],
      ES: ["ES", "Spain", "España", "Espagne", "Spanien", "Spagna", "Espanha", "Spania"],
      LK: ["LK", "Sri Lanka"],
      SD: ["SD", "Sudan", "Soudan"],
      SR: ["SR", "Suriname"],
      SE: ["SE", "Sweden", "Sverige", "Suède", "Schweden", "Svezia", "Suecia", "Suedia"],
      CH: ["CH", "Switzerland", "Schweiz", "Suisse", "Svizzera", "Suiza", "Elveția"],
      SY: ["SY", "Syria", "Syrie", "Siria"],
      TW: ["TW", "Taiwan", "台灣"],
      TJ: ["TJ", "Tajikistan"],
      TZ: ["TZ", "Tanzania", "Tanzanie"],
      TH: ["TH", "Thailand", "Thaïlande", "Tailandia", "Tailanda"],
      TL: ["TL", "Timor-Leste", "East Timor"],
      TG: ["TG", "Togo"],
      TO: ["TO", "Tonga"],
      TT: ["TT", "Trinidad and Tobago"],
      TN: ["TN", "Tunisia", "Tunisie"],
      TR: ["TR", "Turkey", "Türkiye", "Turquie", "Türkei", "Turchia", "Turquía", "Turcia"],
      TM: ["TM", "Turkmenistan"],
      TV: ["TV", "Tuvalu"],
      UG: ["UG", "Uganda", "Ouganda"],
      UA: ["UA", "Ukraine", "Україна", "Ucrania", "Ucraina"],
      AE: ["AE", "United Arab Emirates", "UAE", "Émirats arabes unis", "Emiratele Arabe Unite"],
      GB: ["GB", "UK", "United Kingdom", "Great Britain", "Royaume-Uni", "Großbritannien", "Regno Unito", "Reino Unido", "Marea Britanie", "Regatul Unit"],
      US: ["US", "USA", "United States", "United States of America", "États-Unis", "Vereinigte Staaten", "Stati Uniti", "Estados Unidos", "Statele Unite", "SUA"],
      UY: ["UY", "Uruguay"],
      UZ: ["UZ", "Uzbekistan", "Ouzbékistan"],
      VU: ["VU", "Vanuatu"],
      VA: ["VA", "Vatican City", "Vatican"],
      VE: ["VE", "Venezuela"],
    ...
    // Reverse index: any known variant (lowercased, diacritics stripped) -> ISO code
    const stripDiacritics = (s: string) => s.normalize("NFD").replace(/[\u0300-\u036f]/g, "");
    const variantToCode: Record<string, string> = {};
    for (const [code, list] of Object.entries(COUNTRY_VARIANTS)) {
      for (const v of list) {
        variantToCode[stripDiacritics(v).toLowerCase()] = code;
      }
    }

    const resolveCountryCode = (input: string | null | undefined): string | null => {
      if (!input) return null;
      const key = stripDiacritics(input.trim()).toLowerCase();
      return variantToCode[key] || null;
    };

    const getCountryVariants = (country: string | null) => {
      if (!country) return [];
      const c = country.trim();
      const code = resolveCountryCode(c) || c.toUpperCase();
      const list = COUNTRY_VARIANTS[code];
      if (list) return Array.from(new Set([c, ...list]));
      return [c];
    };
