...
- experience_level: one of "Beginner", "Intermediate", "Advanced", or null. ONLY set when the user EXPLICITLY references the artist's level/seniority/career stage (NOT when they describe quality — quality goes into quality_filter). Map localized terms:
  ...
  * Advanced = avansat, experimentat, "cu multa experienta", senior, veteran, "vechi in domeniu", profesionist veteran, expert, expérimenté, esperto, erfahren, опытный, etc.
  * IMPORTANT: Words like "bun"/"good"/"top"/"slab"/"bad" are QUALITY judgments (use quality_filter), NOT experience levels. A "beginner" can still be talented; an "advanced" artist can still be poorly rated. Keep these two dimensions separate.
