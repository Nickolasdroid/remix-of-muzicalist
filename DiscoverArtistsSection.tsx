...
const DiscoverArtistsSection = () => { 
  ...
  // Only collapse when we KNOW there are no artists. While loading we render
  // skeleton cards with the exact final dimensions, so the section occupies
  // its full height from the very first paint — zero layout shift (CLS).
