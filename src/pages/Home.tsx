    ...
    <div className="min-h-screen">
      ...
      <section className="pt-24 md:pt-32 pb-12 md:pb-20 px-4">
        <div className="container mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-display font-bold mb-4 md:mb-6 text-foreground leading-tight">
            Find Your Perfect
      ...
      <section className="py-12 md:py-20 px-4 bg-muted/30">
        <div className="container mx-auto">
          <div className="text-center mb-8 md:mb-12">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-display font-bold mb-3 md:mb-4 text-foreground">
      ...
      <section className="py-12 md:py-20 px-4">
        <div className="container mx-auto">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-display font-bold text-center mb-3 md:mb-4 text-foreground">
            Browse by Category
          </h2>
      ...
      <section className="py-12 md:py-20 px-4">
        <div className="container mx-auto">
          <div className="rounded-2xl md:rounded-3xl bg-gradient-to-br from-card to-secondary p-6 sm:p-8 md:p-12 border-2 border-accent/30 shadow-[var(--shadow-elegant)] text-center">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-display font-bold mb-4 md:mb-6 text-foreground">
