...
const ArtistProfile = () => {
    ...
    return (
      <div className="flex gap-1">
        {[1, 2, 3, 4, 5].map((star) => (
          <Star
            key={star}
            className={`h-5 w-5 ${star <= rating ? "text-accent fill-accent" : "text-muted-foreground"} ${interactive ? "cursor-pointer hover:scale-110 transition-transform" : ""}`}
  ...
  return (
    <div className="min-h-screen ml-64 bg-card">
      <Navigation />
          ...
          <div className="space-y-8">
            <div className="flex flex-col md:flex-row gap-8 mb-8">
              <div className="flex-shrink-0">
                <div
                  className={`p-1 rounded-full bg-gradient-to-br ${isPremium ? "from-yellow-400 via-amber-500 to-yellow-600" : "from-red-500 via-red-600 to-red-500"}`}
                >
                ...
                <div className="flex items-center justify-between flex-wrap gap-4">
                  <div>
                    <div className="flex items-center gap-3 mb-2">
                      <h1 className="text-4xl font-display font-bold text-foreground">{artist.stage_name}</h1>
                    </div>
            ...
            <Tabs defaultValue="details" className="w-full">
              ...
              <TabsContent value="details" className="space-y-8">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground leading-relaxed text-lg">{artist.bio || "No bio available."}</p>
                </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      <p className="text-muted-foreground">
                        <span className="font-semibold text-foreground">{getExperienceYears()} years</span> of
                        professional experience
                      </p>
                      <p className="text-muted-foreground flex items-center gap-2">
                        <Award className="h-4 w-4 text-accent" />
                        <span className="font-semibold text-foreground">{artist.number_of_events}+</span> events
                        performed
                      </p>
                    </div>
                  </div>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-3">
                    ...
                    {!artist.facebook_url &&
                      ...
                      !artist.youtube_url &&
                      !artist.tiktok_url &&
                      !artist.spotify_url && <p className="text-muted-foreground">No social media links available.</p>}
                  </div>
                </div>
                        ...
                        <Card key={post.id} className="overflow-hidden border-border/40 shadow-sm rounded-lg">
                          ...
                          <div className="p-4 pb-0">
                            <div className="flex items-start justify-between">
                              <div className="flex items-center gap-3">
                                <div
                                  className={`p-0.5 rounded-full ${artist?.plan === "Premium" ? "bg-gradient-to-r from-yellow-400 via-amber-500 to-yellow-600" : "bg-gradient-to-r from-red-500 via-red-600 to-red-500"}`}
                                >
            ...
            <Dialog open={reviewDialogOpen} onOpenChange={setReviewDialogOpen}>
              <DialogContent className="sm:max-w-[500px]">
                <DialogHeader>
                  ...
                  <DialogDescription>Share your experience with this artist</DialogDescription>
                </DialogHeader>
        ...
        <DialogContent className="max-w-[95vw] max-h-[95vh] p-0 bg-black/95 border-none [&>button]:text-white">
          <div className="flex items-center justify-center w-full h-full p-4">
            {mediaPreview?.type === "video" ? (
              <video src={mediaPreview.url} controls autoPlay className="max-w-full max-h-[85vh] object-contain" />
            ) : (
              <img src={mediaPreview?.url} alt="Full size preview" className="max-w-full max-h-[85vh] object-contain" />
            )}
          </div>
        </DialogContent>
      </Dialog>
