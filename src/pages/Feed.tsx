                ...
                <Card key={`promo-${item.id}`} className="text-card-foreground overflow-hidden shadow-sm my-0 border-solid rounded-none border-secondary bg-background border-0">
                  ...
                  <div className="flex items-center gap-0 px-2 py-0 -mt-1">
                    <Button
                      ...
                      className={`h-[100px] w-[100px] rounded-full hover:bg-transparent ${item.isLiked ? "text-destructive" : "text-muted-foreground"}`}
                    >
                      <Heart className={`w-[100px] h-[100px] ${item.isLiked ? "fill-current" : ""}`} />
                    </Button>
