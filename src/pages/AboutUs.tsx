...
const AuthenticatedView = () => (
  <>
    {/* Existing premium dashboard about retained for logged-in users */}
    <section className="pt-24 md:pt-16 pb-20 px-6 md:px-10 relative overflow-hidden">
      ...
      <div className="relative max-w-5xl mx-auto text-center">
        <p className="text-xs tracking-[0.3em] text-accent/80 mb-6">ABOUT MUZICALIST</p>
        <h1 className="text-4xl md:text-6xl font-display font-semibold mb-6 text-foreground">
          About <span className="bg-gradient-to-r from-accent to-accent/60 bg-clip-text text-transparent">Muzicalist</span>
        </h1>
