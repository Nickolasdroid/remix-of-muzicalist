        ...
        <div className="container mx-auto">
          ...
          <Tabs defaultValue="singers" className="w-full">
            ...
            {loading ? <div className="text-center py-16">
              ...
              </div> : Object.entries(categories).map(([key, categoryArtists]) => <TabsContent key={key} value={key} className="space-y-3 md:space-y-6">
                  <div className="grid gap-3 md:gap-6 max-w-2xl mx-auto">
