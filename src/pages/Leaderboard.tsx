      ...
      <div className="pt-20 md:pt-32 pb-24 md:pb-20 px-0">
        <div className="container mx-auto">
          ...
          <Tabs defaultValue="singers" className="w-full -mx-4 md:mx-0 w-[calc(100%+2rem)] md:w-full">
            <TabsList className="grid w-full grid-cols-4 mb-6 md:mb-12 p-1 rounded-none md:rounded-xl md:max-w-2xl md:mx-auto md:bg-card/50 md:border-2 md:border-accent/30">
