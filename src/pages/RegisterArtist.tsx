...
const RegisterArtist = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-background via-secondary to-background" style={{ scrollbarWidth: 'none', WebkitOverflowScrolling: 'touch' }}>
