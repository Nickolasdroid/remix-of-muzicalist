...
const CountyArtists = () => {
  ...
  useEffect(() => {
    const fetchArtists = async () => {
      ...
      const { data, error } = await supabase
        .from('profiles')
        .select('id, stage_name, avatar_url, plan, specialization, experience_level')
        .ilike('county', county);
  ...
  const filteredArtists = useMemo(() => {
    ...
    if (filterSpecialization !== "all") {
      result = result.filter(artist => artist.specialization === filterSpecialization);
    }
    ...
    return result;
  }, [artists, filterSpecialization, filterExperience, sortOrder]);
      ...
      <div className="container mx-auto px-4 pt-32 pb-20">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Browse through talented artists in this county
          </p>
        </div>
