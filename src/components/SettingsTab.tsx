...
const DesktopSettingsLayout = ({
  ...
  return (
    <div className="w-full lg:fixed lg:inset-y-0 lg:left-64 lg:right-0 lg:z-20 bg-background lg:bg-card">
      <div className="flex flex-col lg:flex-row gap-0 px-0 py-0 lg:h-full">
        ...
        {showContent && (
          <div className="flex-1 min-w-0 lg:h-full lg:overflow-y-auto">
            <div className="bg-card px-4 py-4 lg:p-10 lg:min-h-full">
