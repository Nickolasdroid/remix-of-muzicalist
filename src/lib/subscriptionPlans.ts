...
export const subscriptionPlans: SubscriptionPlan[] = [
  {
    ...
    features: [
      ...
      { text: 'Browse Home (posts) & Announcements (opportunities)', included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'Appear in Leaderboard rankings', included: true },
      { text: 'Appear in Home (posts) & Announcements (opportunities)', included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'Visible social media links', included: true },
      { text: 'Appear in Leaderboard rankings', included: true },
      { text: 'Priority visibility in Home (posts) & Announcements (opportunities)', included: true },
